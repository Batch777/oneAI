...
Skipped by default; run with:  ONEAI_LIVE_TEST=1 pytest tests/legacy/test_live.py
...
from oneai.legacy.runtime import Runtime
...
def test_agent_uses_vault_search_and_cites():
    ...
    assert "[[" in answer and ".md@" in answer and "#L" in answer  # citation present
