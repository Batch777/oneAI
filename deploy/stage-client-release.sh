...
set -euo pipefail
cd /root
printf '%s\n' '756b151df2a9a3f9f586847411436eafc42e5e95608ab74242b65cd8eb681f9d  oneai-app-ui-v2.tar.gz' '21bf9ffd921e73c37b741be87ec595ecc3d25679885b71d2eb44c3c06a236da9  oneai-app-service-v3.tar.gz' | sha256sum -c -
...
tar -xzf oneai-app-service-v3.tar.gz -C /root/oneai-app-candidate
